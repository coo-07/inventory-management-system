...
function PhotoUpload({ value, onChange }) {
  ...
  return (
    <div
      ...
      className={`relative flex h-[150px] w-full max-w-[220px] cursor-pointer items-center justify-center overflow-hidden rounded-2xl border-2 border-dashed transition-colors ${dragOver ? "" : "hover:border-[var(--ink-soft)]!"}`}
      style={{
